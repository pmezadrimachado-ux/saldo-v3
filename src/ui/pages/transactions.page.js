...
import { renderAccountChoiceGrid } from '../components/finance/account-choice-grid.component.js';
        ...
        content: `
          <form class="transaction-form" data-transaction-form data-filter-category-by-type>
            ...
            <div class="field">
              ...
              ${renderAccountChoiceGrid(accounts)}
              <select class="input input--account-fallback" name="accountId" required>
